...
BEGIN
    ...
    FOR i IN 1..16 LOOP
        ...
        VALUES ('Boni Atas ' || lpad(i::text, 2, '0'), 'Boni', 'Atas', 8);
    END LOOP;
    
    -- Gedung Boni Kanan: Bawah 12 kamar
    FOR i IN 1..12 LOOP
        INSERT INTO public.rooms (name, building, floor, capacity) 
        VALUES ('Boni Bawah ' || lpad(i::text, 2, '0'), 'Boni', 'Bawah', 8);
    END LOOP;
    
    -- Gedung Yosef Kiri: Atas 12 kamar
    FOR i IN 1..12 LOOP
        INSERT INTO public.rooms (name, building, floor, capacity) 
        VALUES ('Yosef Atas ' || lpad(i::text, 2, '0'), 'Yosef', 'Atas', 8);
    END LOOP;
    
    -- Gedung Yosef Kiri: Bawah 12 kamar
    FOR i IN 1..12 LOOP
        INSERT INTO public.rooms (name, building, floor, capacity) 
        VALUES ('Yosef Bawah ' || lpad(i::text, 2, '0'), 'Yosef', 'Bawah', 8);
    END LOOP;
END $$;
